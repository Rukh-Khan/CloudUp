...
// Custom SlideDownWrapper
const SlideDownWrapper = ({ children, ...props }) => {
  ...
  return <SlideDown {...props}>{children}</SlideDown>;
};
  ...
  return (
    ...
    >
      <div className='font-bold font-poppins flex-1'>
        ...
        <div className="que">
          {item.question}
          <SlideDownWrapper className="max-lg:w-full w-96">
            {activeId === item.id && (
