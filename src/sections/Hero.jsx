...
const Hero = () => {
  return ( 
    <section id="hero">
      <div className='relative max-container min-h-screen flex md:flex-row items-center justify-center max-md:mt-10 max-lg:mt-10 pointer-events-auto max-sm:p-2'>
        <div className="relative flex flex-col w-full lg:w-3/5  max-[640px]:mx-auto max-lg:left-5 lg:ml-10 max-md:-top-40 space-y-7 z-10 md:justify-center md:space-y-10 lg:-top-1 lg:space-y-7 lg:tracking-widest">
            <p className="text-rose-400 max-md:whitespace-nowrap max-md:mt-60 z-10 text-xl md:mt-20 md:text-3xl lg:text-xl max-lg:max-w-80">Beyond Cloud Storage</p>
            <p className="mb-6 max-md:font-extrabold max-md:text-5xl bg-gradient-to-br from-blue-400 to-blue-700 bg-clip-text text-transparent z-10 md:h2 lg:h3 xl:h22 max-xl:max-w-80 xl:max-w-96">AI POWERED DIGITAL STORER & <span className='lg:whitespace-nowrap'>WORK SPACE</span></p>
            
            <div className='max-2xl:max-w-80 font-sans z-10 body-1 tracking-widest hero_sub_head'
            >
